...
param (
    ...
    $ReportTemplate = "$pwd\ReportTemplate.docx"
)
...
If ($GUCount -gt 0) {
    ...
    # InsertTableHeading "SPF Configuration"

    #Set Cell Widths
    # $cellWidths = New-Object System.Collections.ArrayList

    #Create Table
    # CreateTable $SPFrecordsArray $cellWidths $false 
...
If ($GUCount -gt 0) {
    ...
    # InsertTableHeading "CAS Mailbox Plan Configuration"

    #Set Cell Widths
    # $cellWidths = New-Object System.Collections.ArrayList

    #Create Table
    # CreateTable $CASMailboxPlanArray $cellWidths $false 
...
If ($GUCount -gt 0) {
    ...
    # InsertTableHeading "Authentication Policy Configuration"

    #Set Cell Widths
    # $cellWidths = New-Object System.Collections.ArrayList

    #Create Table
    # CreateTable $EOAuthenticationPolicyArray  $cellWidths $false 
...
If ($GUCount -gt 0) {
    ...
    # InsertTableHeading "Outlook Web Access Policy Configuration"

    #Set Cell Widths
    # $cellWidths = New-Object System.Collections.ArrayList

    #Create Table
    # CreateTable $OWAMailboxPolicyArray  $cellWidths $false 
...
If ($GUCount -gt 0) {
    ...
    # InsertTableHeading "Address List Configuration"

    # #Set Cell Widths
    # $cellWidths = New-Object System.Collections.ArrayList

    # #Create Table
    # CreateTable $EOAddressListsArray  $cellWidths $false 
...
If ($GUCount -gt 0) {
    ...
    # InsertTableHeading "Connection Filters Configuration"

    # #Set Cell Widths
    # $cellWidths = New-Object System.Collections.ArrayList

    # #Create Table
    # CreateTable $EOPConnectionFilterArray  $cellWidths $false 
...
If ($GUCount -gt 0) {
    ...
    # InsertTableHeading "Malware Filter Configuration"

    # #Set Cell Widths
    # $cellWidths = New-Object System.Collections.ArrayList

    # #Create Table
    # CreateTable $EOPMalwareFilterArray  $cellWidths $false 
...
If ($GUCount -gt 0) {
    ...
    # InsertTableHeading "Policy Filter Configuration"

    # #Set Cell Widths
    # $cellWidths = New-Object System.Collections.ArrayList

    # #Create Table
    # CreateTable $EOPPolicyFilterArray  $cellWidths $false 
...
If ($GUCount -gt 0) {
    ...
    # InsertTableHeading "Content Filter Configuration"

    # #Set Cell Widths
    # $cellWidths = New-Object System.Collections.ArrayList

    # #Create Table
    # CreateTable $EOPContentFilterArray  $cellWidths $false 
...
If ($GUCount -gt 0) {
    ...
    # InsertTableHeading "Client Configuration"

    # #Set Cell Widths
    # $cellWidths = New-Object System.Collections.ArrayList

    # #Create Table
    # CreateTable $TeamsClientConfigArray  $cellWidths $false
...
If ($GUCount -gt 0) {
    ...
    # InsertTableHeading "Channel Policy Configuration"

    # #Set Cell Widths
    # $cellWidths = New-Object System.Collections.ArrayList

    # #Create Table
    # CreateTable $TeamsChannelPolicyArray  $cellWidths $false 
...
If ($GUCount -gt 0) {
    ...
    # InsertTableHeading "Calling Policy Configuration"

    # #Set Cell Widths
    # $cellWidths = New-Object System.Collections.ArrayList

    # #Create Table
    # CreateTable $TeamsCallingPolicyArray  $cellWidths $false 
...
If ($GUCount -gt 0) {
    ...
    # InsertTableHeading "Meeting Policy Configuration"

    # #Set Cell Widths
    # $cellWidths = New-Object System.Collections.ArrayList

    # #Create Table
    # CreateTable $TeamsMeetingPolicyArray  $cellWidths $false 
...
If ($GUCount -gt 0) {
    ...
    # InsertTableHeading "Messaging Configuration"

    # #Set Cell Widths
    # $cellWidths = New-Object System.Collections.ArrayList

    # #Create Table
    # CreateTable $TeamsMessagingPolicyArray  $cellWidths $false 
...
If ($GUCount -gt 0) {
    ...
    # InsertTableHeading "Meeting Broadcast Policy Configuration"

    # #Set Cell Widths
    # $cellWidths = New-Object System.Collections.ArrayList

    # #Create Table
    # CreateTable $TeamsMeetingBroadcastPolicyArray  $cellWidths $false 
...
If ($GUCount -gt 0) {
    ...
    # InsertTableHeading "Tenant Configuration"

    # #Set Cell Widths
    # $cellWidths = New-Object System.Collections.ArrayList

    # #Create Table
    # CreateTable $SharepointArray  $cellWidths $false 
...
If ($GUCount -gt 0) {
    ...
    # InsertTableHeading "Retention Labels Configuration"

    # #Set Cell Widths
    # $cellWidths = New-Object System.Collections.ArrayList

    # #Create Table
    # CreateTable $RetentionLabelArray  $cellWidths $false 
...
If ($GUCount -gt 0) {
    ...
    # InsertTableHeading "Retention Label Policy Configuration"

    # #Set Cell Widths
    # $cellWidths = New-Object System.Collections.ArrayList

    # #Create Table
    # CreateTable $RetentionpolicyArray  $cellWidths $false 
...
If ($GUCount -gt 0) {
    ...
    # InsertTableHeading "Sensitivity Label Configuration"

    # #Set Cell Widths
    # $cellWidths = New-Object System.Collections.ArrayList

    # #Create Table
    # CreateTable $SensitivityLabelsArray  $cellWidths $false 
...
If ($GUCount -gt 0) {
    ...
    # InsertTableHeading "Sensitivity label Policy Configuration"

    # #Set Cell Widths
    # $cellWidths = New-Object System.Collections.ArrayList

    # #Create Table
    # CreateTable $SensitivitylabelpolicyArray  $cellWidths $false 
...
If ($GUCount -gt 0) {
    ...
    # InsertTableHeading "Dlp Compliance Policy Configuration"

    # #Set Cell Widths
    # $cellWidths = New-Object System.Collections.ArrayList

    # #Create Table
    # CreateTable $DlpCompliancePolicyArray  $cellWidths $false 
...
#############################################
# Write-Host " - Updating Document Fields" -foregroundcolor Gray
# UpdateBuiltInField "Author" "oobe PL"
# UpdateBuiltInField "Title" "Office 365"
# UpdateBuiltInField "Subject" "As Built As Configured"
# UpdateDocumentField "DocumentDate" $(Get-Date).ToShortDateString()

#############################################
#Highlight TODO text
#############################################
# Write-Host " - Highlighting TODO fields" -foregroundcolor Gray
# HighlightText "TODO" "!!!!" "TBD"

#############################################
#Update Table of Contents
#############################################
# Write-Host " - Updating Table of Contents" -foregroundcolor Gray
# foreach ($objTOC in $objWordDoc.TablesOfContents)
# {
#     $objTOC.Update() > $null
#     $objTOC.UpdatePageNumbers() > $null
# }

#############################################
#Save File
#############################################
# If (!(test-path "$pwd\Reports\")) {
#     new-item -type Directory "$pwd\Reports\"
# }
# $SaveFormat = "microsoft.office.interop.word.WdSaveFormat" -as [type]
# $objWordDoc.saveas("$ReportFileName", $SaveFormat::wdFormatDocumentDefault)

#############################################
#Go to start of document
#############################################
# [ref]$GotoWhat = "microsoft.office.interop.word.WdGoToItem" -as [type]
# [ref]$GotoWhich = "microsoft.office.interop.Word.WdGoToDirection" -as [type]
# $objword.Selection.GoTo($GotoWhat::wdGoToLine,$GotoWhich::wdGoToAbsolute,1) > $null
...
# Get-MsolCompanyInformation (Doesn't seem to work with Guest accounts!)
# TechnicalNotificationEmails             : {stephen.tys@oobe.com.au}
...
######AAD Connection Section######
# SelfServePasswordResetEnabled           : True
# DirectorySynchronizationEnabled         : True
# DirSyncServiceAccount                   : Sync_KFYSPMGT01_028b9510cf4e@oobecloud.onmicrosoft.com
# LastDirSyncTime                         : 15/12/2018 7:55:05 AM
# LastPasswordSyncTime                    : 15/12/2018 8:11:09 AM
########################################################
